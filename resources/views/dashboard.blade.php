                ...
                <div class="col d-flex">
                    <div class="card rounded-4 overflow-hidden w-100">
                        ...
                        <ul class="list-group list-group-flush">
                            <li
                                class="list-group-item d-flex align-items-center justify-content-between bg-transparent border-top">
                                <i class="bi bi-tablet-landscape-fill me-2 text-primary"></i> <span>Tablet - </span>
                                <span>22.5%</span>
                            </li>
                            <li
                                class="list-group-item d-flex align-items-center justify-content-between bg-transparent">
                                        ...
                                        <div class="d-sm-flex align-items-center gap-3 mt-3">
                                            ...
                                            <div class="align-self-end ms-auto">
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <p class="mb-0 font-13">
                                                        <i class="bi bi-square-fill ms-1 text-primary-3"></i>
                                                        Returning Visitors
                                                    </p>
                                                </div>
                                            </div>
